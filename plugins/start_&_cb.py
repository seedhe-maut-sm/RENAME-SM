...
async def start(client, message):
    ...
    buttons = [
        [InlineKeyboardButton('♨️ Updates', url='https://t.me/seedhe_maut'),
         InlineKeyboardButton('⭕️ Sᴜᴩᴩᴏʀᴛ', url='https://t.me/seedhe_maut')],
        [InlineKeyboardButton('💢 About', callback_data='about'),
         InlineKeyboardButton('🥹 Help', callback_data='help')],
        [InlineKeyboardButton('📹 Watch Video', callback_data='watch_video')],  # New button for sending videos
        [InlineKeyboardButton("👨‍💻 Developer", url='https://t.me/seedhe_maut')]
    ]
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("⚡ 4GB Rename Bot", url="https://t.me/seedhe_maut")],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("🤖 More Bots", url="https://t.me/seedhe_maut")],
                [InlineKeyboardButton("🔒 Close", callback_data="close"),
                 InlineKeyboardButton("◀️ Back", callback_data="start")]
            ])            
        )
